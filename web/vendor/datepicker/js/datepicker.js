...
gj.widget = function () {
    ...
    messages: {
        "en-us": {
            monthNames: [
                ...
                "November",
                "December"],
            monthShortNames: ["Jan", "Feb", "Maa", "Apr", "Mei",
                "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dec"],
            weekDaysMin: ["ZO", "MA", "DI", "WO", "DO", "VR", "ZA"],
            weekDaysShort: ["Zon", "Maa", "Din", "Woe", "Don", "Vri", "Zat"],
            weekDays: ["Zondag", "Maandag", "Dinsdag", "Woensdag",
        ...
        var c = a.getBoundingClientRect(), d = gj.core.height(a, !0),
            e = gj.core.height(b, !0), f = gj.core.width(a, !0),
            g = gj.core.width(b, !0),
    ...
    init: function (a) {
        ...
        var b, c, d = a.data(), e = d.params[d.paramNames.sortBy],
        ...
        return a.find('tbody tr[data-role="row"]').each(function () {
            var c = $(this), d = c.data("position"), e = a.get(d),
    ...
    config: {
        ...
        expandDetail: function (a, b, c) {
            var d = b.closest("tr"), e = $('<tr data-role="details" />'),
                ...
                g = $('<div data-role="display" />'), h = a.data(),
                i = d.data("position"), j = a.get(i),
            ...
            var d = b.closest("tr"), e = d.next('tr[data-role="details"]'),
                f = a.data(), g = gj.grid.plugins.expandCollapseRows;
        ...
        collapseAll: function () {
            ...
            var b = this, c = a.data("details"), d = c.html(),
        ...
        init: function (a) {
            ...
            return function (c, d) {
                $('table[data-role="draggable-clone"]').draggable("destroy").remove(), a.removeClass("gj-unselectable"), b.siblings('tr[data-role="row"]').each(function () {
                    var c, e, f, g, h, i = $(this), j = i.data("position"),
                        k = b.data("position"), l = a.data();
    ...
    config: {base: {}}, public: {
        getCSV: function (a) {
            var b, c, d = "", e = "", f = this.data().columns,
                g = this.getAll(a);
            if (g.length) {
    ...
    init: function (a) {
        ...
        var d, e, f = b.find('>[data-role="wrapper"]>[data-role="expander"]'),
            g = a.data(), h = b.attr("data-id"), i = b.children("ul");
    ...
    config: {
        ...
        nodeDataBound: function (a, b) {
            ...
            var c = b.children('[data-role="wrapper"]'),
                ...
                e = c.children('[data-role="spacer"]'), f = b.children("ul"),
                g = a.data(),
    ...
    init: function (a) {
        ...
        var c = a.data(), d = a.parent().find('[role="expander"]'),
    ...
    init: function (a) {
        ...
        var d, e, f, g, h, i, j, k, l, m, n, o, p, q, r,
            s = b.children('[role="body"]'), t = $("<table/>"),
        ...
        var c, d = !0, e = gj.datepicker.methods.getMinDate(a),
        ...
        var e = (d.getDate(), d.getMonth()), f = d.getFullYear(),
    ...
    init: function (a) {
        ...
        var b, c = a.data(),
            ...
            e = $('<div role="hour" />'), f = $('<div role="minute" />'),
            g = $('<div role="header" />'), h = $('<div role="mode" />'),
            i = $('<div role="body" />'),
        ...
        return function () {
            var c = gj.timepicker.methods.getHour(b),
                d = gj.timepicker.methods.getMinute(b), e = b.attr("mode"),
                f = new Date(0, 0, 0, 12 === c && "am" === e ? 0 : c, d),
                g = a.data(), h = gj.core.formatDate(f, g.format, g.locale);
            a.value(h), a.close()
        }
        ...
        var e, f, g = b.mouseX(a), h = b.mouseY(a),
            i = window.scrollY || window.pageYOffset || 0,
