...
# Database: whuk
# Generation Time: 2020-08-01 09:48:18 +0000
# ************************************************************
...
INSERT INTO `account` (`account_ID`, `account_name`, `account_email`, `account_password`, `account_rights`, `account_login_token`, `account_failed_login`, `account_is_blocked`, `account_is_deleted`)
VALUES
...
CREATE TABLE `contact_form` (
  ...
  `contact_form_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `contact_form_email` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `contact_form_message` text COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `contact_form` (`contact_form_id`, `contact_form_name`, `contact_form_email`, `contact_form_message`, `contact_form_created_at`, `contact_form_is_deleted`)
VALUES
...
INSERT INTO `event` (`event_ID`, `event_slug_ID`, `event_thumbnail_ID`, `event_banner_ID`, `event_title`, `event_content`, `event_location`, `event_date`, `event_is_published`, `event_is_archived`, `event_is_deleted`)
VALUES
...
INSERT INTO `file` (`file_ID`, `file_path`, `file_is_deleted`)
VALUES
...
INSERT INTO `menu` (`menu_ID`, `menu_slug_ID`, `menu_title`, `menu_weight`, `menu_is_deleted`)
VALUES
	(1,3,'Concerten',1,1),
	(2,3,'Concerten',1,1),
	(3,3,'Concerten',1,1),
...
INSERT INTO `page` (`page_ID`, `page_slug_ID`, `page_thumbnail_ID`, `page_banner_ID`, `page_title`, `page_content`, `page_in_menu`, `page_is_published`, `page_is_deleted`)
VALUES
...
INSERT INTO `setting` (`setting_ID`, `setting_key`, `setting_value`, `setting_is_deleted`)
VALUES
...
INSERT INTO `slug` (`slug_ID`, `slug_name`, `slug_is_deleted`)
VALUES
	(1,'home',0),
...
INSERT INTO `translation` (`translation_ID`, `translation_key`, `translation_value`, `translation_language`, `translation_is_deleted`)
VALUES
