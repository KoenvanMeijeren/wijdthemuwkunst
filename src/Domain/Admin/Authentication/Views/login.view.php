                        ...
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">
                                    <?php echo Translation::get('login_page_title') ?>
                                </h1>
                            ...
                            <form class="user" method="post" action="/admin/login">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-user" type="email" id="email"
                                           ...
                                           placeholder="<?php echo Translation::get('form_email_placeholder') ?>">
                                </div>

                                <div class="form-group">
                                    <label for="password">
                                        <b>
                                            <?php echo Translation::get('form_password') ?>
                                            <span>*</span>
                                        </b>
                                    </label>
                                    <input class="form-control form-control-user" type="password" id="password"
                                           name="password" required
                                           placeholder="<?php echo Translation::get('form_password_placeholder') ?>">
                                </div>

                                <button class="btn btn-primary btn-user btn-block" type="submit">
                                    <?php echo Translation::get('login_button') ?>
