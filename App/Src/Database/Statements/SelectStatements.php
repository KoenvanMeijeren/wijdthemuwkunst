...
/**
 * Provides a trait with select statements to interact with the database.
 *
...
trait SelectStatements {
   ...
   *
   * @param string $table
   *   The table to union select from.
   * @param string[] ... $columns
   ...
   *
   * @param string $table
   *   The table to union all select from.
   * @param string[] ... $columns
   ...
   * @param string $tableOneColumn
   *   The first table column to
   *   full outer join on.
   * @param string $tableTwoColumn
   *   The second table column to
   *   full outer join on.
   *
   * @return $this
   */
